...
VALUES (
	...
	(
		'OSTANKAABB',
		'5, 10 & 25 litre capacity options',
	...
	(
		'OSWASH',
		'Suitable for fixed or PTZ cameras',
		'Easy installation & maintenance',
...
VALUES (
		'OS06BS',
		'Stainless steel wall bracket for fixed cameras',
		'',
		'',
		'Not available',
		'',
	...
	(
		'OS01BY',
		'Stainless steel wall bracket for PTZ cameras',
		'',
		'',
		'Not available',
		'',
		'',
		'',
		'Heavy duty bracket made of AISI 316L thick gauge stainless steel.  It is designed for stainless steel weatherproof and explosionproof housings. Can be combined with pole and corner mount adapters.',
		'Suitable for PTZ cameras',
		'',
		'',
		'',
	...
	(
		'OSTANKAABB',
		'Washer tank for marine cameras',
		'',
		'',
		'',
		'',
	...
	(
		'OSWASH',
		'Washer nozzel for marine cameras',
		'',
		'',
		'',
		'',
	...
	(
		...
		'',
		'',
		'The armoured, barrier cable with gland secures the cable and cable connections from tampering.  \nand wet/humid environments.  It is ATEX certified.\n15 or 20mm cable gland.',
		'Explosion proof conduit pipe',
		'Flame resistant',
		'Oil resistant',
		'Water resistant',
	...
	(
		'OS07CBD',
		'Explosionproof stainless steel junction box',
		'',
		'',
		'Not available',
		'',
	...
	(
		'OS08CBJ44-A',
		'Explosionproof aluminium junction box',
		'',
		'',
		'Not available',
		'',
		'',
		'',
		'This is a versatile flameproof ATEX explosionproof junction box for use in Zone 1/21 hazardous areas, specifically designed for CCTV systems.\nIt is made of aluminium.  Cable entries are available from 2 to 8 enabling a wide range of connection options.\n25mm cable entry.',
		'',
		'',
		'IIC',
		'',
...
VALUES (
	...
	(
		'OSTANKAABB',
		'AISI316L Stainless Steel; Tank HDPE HMW',
		'',
		'',
		'',
		'-20° +60°C (-4° +140° F)',
		'3kg (5L); 4kg(10L); 7kg(25L)',
		'279Hx195Wx263D (5L); 353Hx235Wx290D(10L); 527Hx315Wx355D(25L);\nGxFxH (see drawing)',
		'For 5.5-8mm diameters cables',
		'Wall'
	),
	(
		'OSWASH',
...
VALUES (
	...
	(
		...
		'',
		'1920Ã—1080 (2MP)',
		'2 megapixel and following 25 frame(full-time), support 1~25 fps Â is adjustable',
		'ColorÂ 0.1Lux@F1.2,BW0.01Â Lux@F1.2;',
		'4mmã€6mm options',
		'',
		'',
		'',
		...
		'n/a',
		'',
		'Rotate mode, Saturation, Brightness, Contrast adjustable by Â client software or web browser',
		'',
		'',
		'H.264/H.265/MJPEG',
		'32 Kbps~8Mbps',
	...
	(
		...
		'',
		'Max. 25fps',
		'Colour: 0.03Lux;B/W: 0Lux(IR LED on)',
		'2.8mm fixed or 2.7-12mm varifocal',
		'8x',
		'',
		'H: 113.7Â° / V: 61.5Â°',
		'',
		...
		'',
		'',
		'DOL HDR, DNR, BLC, HLC, White balance, Exposure control, Mirror, Flip, Colour Corridor format.',
		'Yes',
		'Tamper, Video motion detection',
		'Simultaneously H.265, H.264 and MJPEG (Triple streaming). Independent Frame Rate and Bandwidth Control, VBR/CBR.',
		'',
		'',
		''
	),
	(
		'BSOS2FV0I66',
		'1/2.8â€, 2.1M Sony STARVIS Sensor',
		'2MP',
		'',
		'25fps@1080p',
		'Colour : 0.2Lux@50IRE / F1.2 / 3100K;BW : 0.0005Lux@50IRE / F1.2 ',
		'2.7~12mm, F1.3',
		'',
		'',
		'',
	...
	(
		'BSOA-2Z4I-I67',
		'2MP  1/ 2.8â€ CMOS  1920 x 1080 pixe',
		'2MP',
		'',
		'Dynamic with lens zoom angle. Up to 60m',
		'Colour 0.001lx; Mono 0.001lx @ F1.2',
		'2.7-12mm    Motorised.  Smart auto-focus',
		'',
		'',
		'',
		'',
		...
		'120 dB HDR',
		'Better than 55dB',
		'WDR, BLC, HLC, Defog, DIS',
		'',
		'Perimeter, virtual fences, loitering, objects left/removed, video overlay, email alarm',
		'',
		'',
		'G711 Line in/Line out',
		'From 8kbps to 64kbps; Duplex, bi-directional'
	),
	(
		'BSOS12F20I66',
		'1/1.7\" Sony STARVIS CMOS',
		'12MP',
		'',
		'Max. 20fps@4000x3000',
		'Colour: 0.09Lux',
	...
	(
		'DHOS2F4II66M',
		'Â SONY1/3â€³CMOS Senor CCD',
		'',
		'1920Ã—1080 (2MP)',
		'25fps',
		'Color Â 0.1Lux@F1.1, Â BW Â 0.01Â Lux@F1.1;',
		'4mmã€6mmã€8mm Â  Options',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'Â Rotate mode, Saturation, Brightness, Contrast adjustable by client software or web browser',
		'',
		'',
		'H.264/H.265/MJPEG',
		'32 Â Kbps~8Mbps',
		'',
		'BaseLine Â Profile / Main Profile'
	),
	(
		'BHOS2Z18OI66M',
		'Â SONY 1/2.8â€³ CMOS Senor CCD',
		'',
		'1920Ã—1080 (2MP)',
		'25fps',
		'Color Â 0.05Lux@F1.6, Â BW Â 0.01Â Lux@F1.6',
		...
		'Auto exposure Â / aperture priority / shutter priority / manual exposur',
		'Auto Â /manual /one time focusin',
		'na',
		'',
		'',
		'',
	...
	(
		...
		'',
		'',
		'Off / On (4Â Area, Rectangle',
		'Perimeter, Single Virtual Fences, Double Virtual Fences, Object Left, Object Removed',
		'',
		'100Kbps ~ 6Mbps',
		'1ch Audio In,1ch Audio Out(optional)',
		''
	),
	(
		'PHOS2Z260I66M',
		'1/2.8â€³Progressive Â Scan CMOS',
		'â‰¥1000TVL',
		'1920Ã—1080 (2MP)',
		'',
		'Color ï¼š0.001Lux @ (F1.5ï¼ŒAGC ON); BW ï¼š0.0001Lux @(F1.5ï¼ŒAGC Â ON)',
		'Â 5-130mm, 26x',
		'16x',
		'F1.6-F3.5',
		'58.3-3.2Â°(Wide-Tele)',
		'10-1000mm(Wide-Tele)',
		'About 3s( Â optional , Wide-Tele)',
		'',
		'Auto / semi Â auto / manual',
		'na',
		'',
		'',
		'',
		'Built in Micro SD card slot, Â support SD/SDHC/SDXC Micro card (maximum support 256G),support manual / alarm Â video recordi',
		'Auto/ manual / ATW Â / Outdoor / indoor fluorescent lamp / lamp / white balance Â white balan',
		'Yes',
		'ï¼ž 52dB',
		'',
		'Yes',
	...
	(
		...
		'',
		'Max. 25fps@1920x1080',
		'Colour: 0.2Lux@50IRE, BW: 0.01Lux@50IRE',
		'Optical zoom 20x, 4.7-94mmÂ±5%',
		'16x',
		'',
		'H: 55.5Â°-3Â°',
		'',
	...
	(
		...
		'3MP',
		'',
		'IR â€“ 300m; White light â€“ 250m',
		'Colour 0.01lx @ F1.2; Mono 0.0001lx @ F1.2',
		'Motorised x30 zoom 4.5-135mm  ',
		'',
		'',
		'HFOV  59.9-2.3 degrees',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'Perimeter, line crossing, loitering, objects left/removed',
		'H264, H265, MJPEG  ONVIF S, G, Q',
		'100kbps to 12Mbps',
		'',
		''
	),
	...
	(
		'PHOS2Z200I66M',
		'1/2.8â€³Â Progressive Scan CMOS',
		'',
		'',
		'',
		'ColorÂ ï¼š0.05Lux @ (F1.6ï¼ŒAGC ON); BWÂ ï¼š0.01LuxÂ @(F1.6ï¼ŒAGC ON)',
		'4.7-94mmï¼Œ20x',
		'16x',
		'F1.6-F3.5',
		'61.4-2.9Â Â°Â (Wide-Tele )',
		'10-1500mm(Wide-Tele)',
		'About 2.7 s Â (opticalÂ ï¼ŒWide-T',
		'Auto exposure Â / aperture priority / shutter priority / manual exposur',
		'Auto Â /manual /one time focusin',
		'',
		'PAL/NTSC',
		...
		'',
		'Micro SD card 128GB',
		'1/ Â 2Automatic / manual / indoor / outdoor lamp / fluorescent lamp',
		'',
		'>52dB',
		'',
		'',
		...
		'32Â Kbps~16Mbps',
		'1ch Audio In,1ch Audio Out(optional)',
		'G.711-aÂ lawã€G.711-u lawã€G.726'
	),
	(
		'PSOS2Z36II67',
		'1/2\" Sony Exmor CMOS',
		...
		'',
		'Max. 50fps@1920x1080',
		'Colour:0.05Lux;B/W: 0Lux(IR LED)',
		'Optical zoom 36x, 6.0-216mm F1.5',
		'8x',
		'',
		'H: 56.5Â°-2.1Â° / V: 33.6Â°-1.2Â°',
		'',
		'',
		'',
		'',
	...
	(
		...
		'',
		'',
		'ColorÂ ï¼š0.05Lux @ (F1.6ï¼ŒAGC ON); BWÂ ï¼š0.01LuxÂ @(F1.6ï¼ŒAGC ON); 0',
		'4.7-94mmï¼Œ20x',
		'16x',
		'F1.6-F3.5',
		'61.4-2.9Â Â°Â (Wide-Tele )',
	...
	(
		...
		'',
		'ColorÂ ï¼š0.05Lux @ (F1.6ï¼ŒAGC ON); BWÂ ï¼š0.01LuxÂ @(F1.6ï¼ŒAGC ON)',
		'4.7-94mmï¼Œ20X optical',
		'',
		'F1.6 â€“ F5',
		'65.5-2.11 degree (Wide-Tele)',
		'10-1500mm(Wide-Tele)',
		'Approx.3s(Optical Wide-Tele)',
		'Auto exposure Â / aperture priority / shutter priority / manual exposur',
		'Auto Â /manual /one time focusin',
		'',
		'',
	...
	(
		...
		'',
		'0lx IR',
		'2.8-12mm x4  30.9-102.8 degrees',
		'',
		'',
		'',
		'',
		...
		'120dB',
		'',
		'Auto Exposure, Auto White Balance, Auto and Manual Iris, Back Light Compensation',
		'',
		'',
		'H264/265/MJPEG',
		'',
	...
	(
		...
		'',
		'25fps',
		'Colour: 0.03Lux, B/W: 0.01Lux',
		'2.8, 2.7-12 or 3.2-10.5mm',
		'8x',
		'',
		'H: 113.7Â° / V: 61.5Â°; H: 108.8Â°-32.3Â° / V: 57.2Â°-18.2Â°; H: 108.8Â°-32.3Â° / V: 57.2Â°-18.2Â°; or H: 108.1Â°-30.3Â° / V:',
		'',
		'',
		'',
		'',
	...
	(
		...
		'',
		'',
		'Colour 0.003lx @ F1.2; Mono 0.001lx @ F1.2; 0lx',
		'2, 2.8, 4, 6 mm  HFOV  126, 108, 86 or 53 degrees',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'MicroSD/SDHC/SDXC card up to 128GB',
		'',
		'120dB',
		'',
		'Image enhancement: BLC, 3D DNR, HLC, defog, EIS',
		'',
		'Line crossing detection, intrusion detection, region entrance detection, region exit detection, unattended baggage detection, object removal detection',
		'H265/265+, H264/264+',
		'32kbps to 16Mbps',
		'1 audio input (line in), 1 audio output (line out), mono soundtrack',
	...
	(
		...
		'',
		'',
		'Colour 0.006lx @ F1.6; Mono 0.0006lx @ F1.6',
		'Motorised x30 zoom 4.3-129mm  HFOV  63.7-2.3 degrees',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'Perimeter, line crossing, loitering, objects left/removed, people, vehicles',
		'H264, MPEG4, MJPEG  ONVIF S, T, Q',
		'100kbps to 12Mbps',
		'',
		''
	),
	...
	(
		...
		'',
		'Effective pixels: 720x480',
		'25 fps',
		'',
		'',
		'ePTZ: 20x digital zoom (4x on IE plug-in, 5x built-in)',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'Seamless Recording to MicroSD/SDHC/SDXC card and recording to network-attached storage (NAS)',
		'',
		'',
		'',
		'',
		...
		'H.265, H.264, MJPEG',
		'',
		'Two-way Audio (full duplex); External microphone input',
		'G.726, G.711'
	),
	(
		'BHOTS2Z360I68',
	...
	(
		...
		'3840x2160 (8MP)',
		'25 fps',
		'0.02 lux @ F1.5 (colour); 0.01 lux @ F1.5 (B/W); o lux with IR',
		'3.9 ~ 10 mm Motorized, Vari-focal, Remote Focus',
		...
		'',
		'',
		'Seamless Recording to MicroSD/SDHC/SDKC card and recording to network-attached storage (NAS)',
		'',
		'120 dB',
		'61 dB',
		'',
	...
	(
		...
		'3840x2160 (4K/8MP)',
		'25 fps',
		'0.28 lux @ F1.5 (colour); <0.005 lux @ F1.5 (B/W); 0 lux with IR',
		'3.9 ~ 10 mm Motorized, Vari-focal, Remote Focus',
		'',
		'F1.5 ~ F2.7',
		'119Â° ~ 45Â° (Horizontal)',
	...
	(
		'DSOA12F1II66',
		'1/2.3\" Progressive CMOS in 4056x3040',
		'',
		'2944x2944',
		'25 fps',
		'0.1 lux @ F2.0 (colour); <0.005 lux @ F2.0 (B/W); 0 lux with IR',
		'1.22 mm Fixed-focal',
		...
		'H.265, H.264, MJPEG',
		'',
		'Two-way audio (Full duplex); Built-in microphone/ext.input',
		'G.711, G.726'
	),
	(
		'BSOP-2Z4I-I67',
		...
		'',
		'',
		'.001lx col; .0003lx mono; 0lx IR',
		'8-32mm  HFOV 40.3 - 14.4 degrees',
		'',
		'',
		'',
		'',
		...
		'',
		'',
		'MicroSD/SDHC/SDXC card up to 256GB',
		'',
		'140dB',
		'',
		'BLC, HLC, 3D DNR, Defog, EIS, Distortion Correction',
		'',
		'Line crossing,Intrusion, Region entrance/exiting, Unattended baggage, Object removal, Scene change, audio exception, defocus, counting',
		'H265/265+, H264/264+',
		'32kbps to 16Mbps',
		'Mono 8 to 48kHz; 1 line in, 1 line out; 3.5mm jack',
		'G711/722.1/726/MP2l2/PCM/MP3'
	),
	(
		'BSTAIF80I67',
		'Uncooled VOx infrared detector',
	...
	(
		...
		'2560x1920 ',
		'25 fps',
		'0.03 lux @ F1.3 (colour); 0.005 lux @ F1.3 (B/W); 0 lux with IR',
		'4.94 ~ 148.24 mm 30x Optical Zoom, Auto Focus',
		'32x digital zoom (4x on IE plug-in, 8x built in)',
		'F1.3 ~ F4.6',
		'54.1Â° ~ 1.9Â° (Horizontal)',
		'',
		'',
		'',
		'Remote focus, remote zoom',
		...
		'H.265, H.264, MJPEG',
		'',
		'Two-way audio (Full duplex); External line input',
		'G.711, G.726'
	);
-- --------------------------------------------------------
--
...
VALUES (
		'LMCat5E',
		'Cat 5E S/FTP DNV-GL Offshore Marine Approved LAN Cable',
		'`',
		'Not available',
		'',
		'',
		'To meet the demands of the offshore industry this UV  & Oil resistant DNV- GL approved Category 5E cable is used extensively on vessels. LAN cable, designed for ship- and offshore applications. Tinned Cu-connectors and braid, SHF1 jacket.',
		'Designed for ship and offshore applications',
	...
	(
		...
		'AWG 23/7',
		'DNV-GL and Lloyd\'s Register approval',
		'Category 6A DNV- GL marine approved LAN cables are used extensively on vessels',
		'CPR-Compliant options',
		'DNV-GL and Lloyd\'s Register approval',
		'Fully compliant to IEC',
		'Transmission speeds up to 1GBps',
...
VALUES (
	...
	(
		'PSOA-3Z30-XI68',
		'IK10',
		'ASTM B117 1000hr salt-spray',
		'TEN 50556:2011; EN 60068-2-64-2008',
		'',
		'IP68 ',
		'EN 55032:2015  EN 55035:2017 Class A',
		'',
		''
	),
	(
	...
	(
		...
		'',
		'',
		'ATEX Zone 1&2 / 21&22. Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.'
	),
	(
		'BHOS-4Z4I-I66',
		'*',
	...
	(
		...
		'',
		'IP67',
		'EMC: CE (EN 55032 Class A, EN55024), FCC (FCC Part 15 Subpart B Class A), RCM (AS/NZS CISPR 32 Class A), VCCI (VCCI-CISPR 32 Class A); Safety: UL (UL 62368-1), CB (IEC/EN 62368-1, IEC/EN 60950-22, IEC/EN 62471); Environment: IK10 (IEC 62262), IP66/67 (IEC 60529), NEMA (NEMA 250 Type 4X); IA: BIS (IS 13252)',
		'',
		''
	),
	(
		...
		'',
		'IP67, NEMA 4X',
		'CE, FCC Class A, VCCI, C-tick, UL, BIS',
		'',
		''
	),
	(
		...
		'',
		'',
		'IP66 (IEC 60529), NEMA (NEMA 250 Type 4X);',
		'EMC: CE (EN 55032 Class A, EN 55024), FCC (FCC Part 15 Subpart B Class A), VCCI (VCCI-CISPR 32 Class A); UL (UL 62368-1), CB (IEC/EN 62368-1, IEC/EN 60950-22);',
		'',
		''
	),
	(
...
VALUES (
		'STXXXXXVXXXX ',
		'Available from 1TB to 20TB capacity',
...
INSERT INTO `disk_nvr_size_specs` (`product_code`, `size (TB)`)
VALUES ('ST20000VE002 ', 20),
	('ST18000VE002 ', 18),
	('ST16000VE002 ', 16),
	('ST12000VE001 ', 12),
	('ST10000VE001 ', 10),
...
INSERT INTO `ethernet_eth_interface` (`product_code`, `Connector`, `Cable`, `Rate`)
VALUES (
		'OS-CAT5-6TX-POE',
		'RJ45',
		'Patch or crossover, auto detected',
		'100Base-TX or 10Base-T, full-duplex with auto-negotiation'
	),
	(
		'OS-COAXTX-POE',
		'RJ45',
...
VALUES (
		'OS-CAT5-6TX-POE',
		'Long range Ethernet and POE over Cat5 or Cat6 cables allows transmission far beyond standard typical 90m maximum distance',
	...
	(
		'OS-COAXTX-POE',
		'Long range Ethernet and POE over new or legacy coaxial cable',
	...
	(
		'OS-WLIP',
		'IP67 rated enclosure for marine applications',
...
INSERT INTO `ethernet_interface` (
		`product_code`,
		`Connector`,
		`Cable`,
		`cable 1`,
...
VALUES (
		'OS-CAT5-6TX-POE',
		'RJ45',
		'Cat6, Cat5e, Cat3, other 1/2/4-pair UTP',
		'Patch wiring recommended, other wiring auto-corrected',
		'200Mbps (100Mbps full duplex) up to 820 metres [2,690ft] (Cat6)',
		'20Mbps (10Mbps full duplex) up to 1,050 metres [3,450ft] (Cat6), auto-adapts',
		''
	),
	(
		'OS-COAXTX-POE',
		'BNC',
		'75 Ohm Coaxial, RG59, RG6 or RG11 or equivalent',
		'Note: also compatible with 50 Ohm cable types',
		'200Mbit/s up to 690 metres [2263ft] (RG59 20AWG)',
		'200Mbit/s up to 1400 metres [4593ft] (RG11)',
		'20Mbit/s up to 4.2km [2.6miles] (RG11), auto-adapts'
	),
	(
		'OS-WLIP',
...
VALUES (
		'OS-CAT5-6TX-POE',
		'Yellow : Link/activity, Green: power good',
		'Yellow : Link/activity, Green: 10/100Mbps',
		'Power available (5/10/15/20/25 watts)',
		'POE and link status (green/amber), diagnostic codes (red)'
	),
	(
		'OS-COAXTX-POE',
		'Link/activity, power good',
		'Link/activity, rate',
		'Available',
		'POE and link status (green/amber), diagnostic codes (red)'
	),
...
INSERT INTO `ethernet_onboard` (
		`product_code`,
		`Antenna Gain`,
		`Processor`,
		`Memory`
	)
VALUES ('OS-CAT5-6TX-POE', '', '', ''),
	('OS-COAXTX-POE', '', '', ''),
...
VALUES (
		'OS-CAT5-6TX-POE',
		'L 120mm (inc. brackets), W 36mm H 23mm [L 4.7in, W 1.4in, H 0.9in]',
		'100g [3.5oz]',
		'-40°C to 70°C [-40°F to 158°F]',
		'85% non-condensing',
		'FCC, CE, RoHS, UL, BS EN 50121-4 (rail + metro)',
		'Free-standing, wall or rack mount'
	),
	(
		'OS-COAXTX-POE',
		'L 115mm, W 55mm H 27mm, inc removable bracket',
		'112g [3.95oz]',
		'-40°C to 70°C [-40°F to 158°F]',
		'85% non-condensing',
		'FCC, CE, RoHS, BS EN 50121-4 (rail + metro)',
		'Free-standing, wall or rack mount'
	),
	(
		'OS-WLIP',
...
VALUES (
		...
		'',
		'1.0 watt',
		'IEEE 802.3af (POE) or IEEE 802.3at (POE Plus), 2-event, power class 4',
		'IEEE 802.3af (POE) or IEEE 802.3at (POE Plus)',
		'Detachable screw terminal for optional Veracity 54 - 57V supply',
		'',
		''
	),
	(
		'OS-COAXTX-POE',
		'',
		'8-57 volts DC or 20-28 volts AC, max 100mA; 1.0 watts',
		'IEEE 802.3af (POE) or IEEE 802.3at (POE Plus), 2-event, power class 4',
		'IEEE 802.3af (POE) or IEEE 802.3at (POE Plus)',
		'Detachable screw terminal for optional 57V supply',
		'',
		''
	),
	(
		'OS-WLIP',
		'',
		'24V, 0.3A Gigabit PoE Supply; Max 7W',
		'',
		'',
		'',
...
VALUES (
	...
	(
		'BSOS12F28II67',
		'AISI 316L Electro Polished Stainless Steel',
	...
	(
		'BSOA-2Z4I-I67',
		'Tough, vandal-resistant housing, IK10 & IP67',
	...
	(
		'BHOS2F4II66',
		'Explosionproof PTZ Dome Camera certified for use in hazardous environments',
		'ATEX Zone 1&2 / 21&22',
	...
	(
		'BHOS2Z18OI66',
		'Explosionproof Camera certified for use in hazardous environments',
		'ATEX\nII 2G Ex d IIC T6 Gb\nII 2D Ex tb IIIC IP68 T80℃ Db',
		'',
		'Suited to strong corrosive environments. Anti-corrosion, waterproof.',
		'316L grade stainless steel for excellent protection in marine environments',
	...
	(
		'BHTS3F8OI66',
		'Thermal Camera certified for use in hazardous environments',
		'ATEX Zone 1&2 / 21&22',
		'Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.',
		'GE glass designed for thermal cameras',
		'Support 3 temperature measurement rule types (Spot, Line, Area)',
	...
	(
		'PHOS-2Z30O-I69',
		'Stainless steel housing with maximum resistance in corrosive environments',
	...
	(
		'BSOA8FVII67',
		'Range of resolutions from 2MP to 8MP @ 25 fps',
		'',
...
VALUES (
		'NVR0400TB',
		'H.265/H.264 upto 8MP camera supported',
		'4K Display ',
		'4 x PoE Port ',
		'',
...
VALUES (
	...
	(
		...
		'Extendable sun/rain visor option',
		'Manufactured in the United Kingdom',
		'Long life silicone wiper ',
		'Washer option with remote control (WPN400)',
		'',
		'',
		'• Tough, vandal-resistant housing, IK10 & IP67\n• Ruggedised Marine grade\n• PoE+, 24VAC or 12VDC\n• Wide range of camera & lens options\n• Camera/lens options can be factory fitted if required\n• Custom colours available\n• Marine powdercoat paint gives a robust, UV light-stable finish\n• Fully cable-managed solution, keeps cables hidden and secure\n• No need for additional junction box\n• Wall-bracket, pendant or pedestal mount options\n• Extendable sun/rain visor option\n• Manufactured in the United Kingdom'
	),
	(
		'BHTS0000066',
		'Thermal Camera Housing certified for use in hazardous environments',
		'ATEX Zone 1&2 / 21&22',
		'Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.',
		'GE glass designed for thermal cameras',
		'',
	...
	(
		'DHOS0000066',
		'Explosionproof Camera Housing certified for use in hazardous environments',
		'ATEX Zone 1&2 / 21&22',
		'Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.',
		'Suited to strong corrosive environments. Anti-corrosion, waterproof.',
		'316L grade stainless steel for excellent protection in marine environments',
	...
	(
		'PHOS0000066',
		'Explosionproof PTZ Dome Camera Housing certified for use in hazardous environments',
		'ATEX Zone 1&2 / 21&22',
		'Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.',
		'Suited to strong corrosive environments. Anti-corrosion 316L, waterproof',
		'',
...
VALUES (
	...
	(
		'BSOA000W067',
		'fixed',
		'Marine camera housing with wiper (& washer option)',
		'',
		'',
		'',
		'',
	...
	(
		'PHOS000I066',
		'ptz',
		'Explosionproof PTZ Housing for Camera - Stainless Steel',
		'',
		'',
		'',
		'',
...
VALUES ('BSOA0000067', '', '', '', '', '', '', '', ''),
	...
	(
		...
		'360°',
		'',
		'Horizontal rotation speed：0.1°-250°/s, rotation speed can be set',
		'-18°-90°',
		'Vertical rotation speed：0.1°-150°/s, rotation speed can be set; Verticalpreset  rotation speed：200°/s',
		'1024',
		'',
		''
	),
	(
		...
		'',
		'Horizontal ：0.1°/S~40°/s Vertical:   ：0.1°/S~40°/s',
		'',
		'',
		'300',
		'',
...
INSERT INTO `housings_optics` (
		`product_code`,
		`IR Illumination range`,
		`Window`
	)
VALUES ('BSOA0000067', '', 'Toughened Glass'),
...
VALUES (
		...
		'',
		'20mm conduit access',
		'3.7kg including bracket ',
		'358L x 152W x 309H (pedestal);\n420L x 152W x 369H (wall)',
		'L 290mm x W 79mm x H103mm',
		'Base/ 20mm conduit access 2x 20mm internal glands',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'BSOA000W067',
		'Die Cast Aluminuim',
		...
		'',
		'20mm conduit access',
		'4.2kg including bracket ',
		'358L x 152W x 309H (pedestal);\n420L x 152W x 369H (wall)',
		'L 228mm x W 79mm x H103mm',
		' Base/ 20mm conduit access 1x 20mm Split Gland; 1x 20mm standard gland',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'BHTS0000066',
		...
		'380mm*143mm*151mm',
		'Φ108x300mm(length',
		'2pcs M25*1.5 output(original G3/4)',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'DHOS0000066',
	...
	(
		...
		'',
		'Φ162x457.5mm(length )',
		'Φ90.5x309.5mm(length )',
		'2pcs M25*1.5 output (original G3/4″ )',
		'Wall hanging, fixed bracket , pedestal base, PTZ'
	),
	(
		'PHOS0000066',
		'316L stainless  steel',
		...
		'80kpa~106 kpa',
		'',
		'Dia 157.5 (6 inch dome) 189.6 H',
		'',
		'1pcs M25*1.5 output(original G3/4), M32 option',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'PHOS0000066',
		...
		'',
		'',
		'1pcs M25*1.5 output(original G3/4)',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'PHOS000I066',
...
VALUES (
	...
	(
		'BSOA000W067',
		'PoE+, 12VDC or 24VAC ',
		'10.8W (12VDC); 6.6W (24VAC); 13W PoE'
	),
	('BHTS0000066', 'DC12V', ''),
...
VALUES (
		...
		'',
		'BSOS-1Z4I-I68',
		'Marine Fixed Bullet Stainless Steel Camera ',
		'example location',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BS0S-1Z4I-I68.jpg\r\n',
		'',
		'',
		'',
	...
	(
		...
		'',
		'DHOS2F4II66M',
		'Marine fixed dome camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/DHOS2F4II66+camera.jpg\r\n',
		'',
		'',
		'',
	...
	(
		...
		'',
		'BHOS2F4II66M',
		'Marine bullet camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2F4II66M+camera.jpg\r\n',
		'',
		'',
		'',
	...
	(
		...
		'',
		'BHOS2Z18OI66M',
		'Marine Zoom Camera with wiper - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2Z18OI66M+camera.jpg\r\n',
		'',
		'',
		'',
	...
	(
		...
		'thermal',
		'BHTS3F8OI66M',
		'Marine thermal Camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHTS3F8OI66M+camera.jpg',
		'',
		'',
		'',
		'The rugged camera is manufactured in 316L stainless steel.  It is a fixed thermal camera station equipped with the latest generation IP thermal camera, LWIR 8-14Âµm Microbolometer, 400 Ã—300 or  640Ã—512 resolution.  It is suitable for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.   ',
		'4,950.00',
		'Â£4,009.50',
		'',
		'',
	...
	(
		...
		'',
		'PHOS2Z260I66M',
		'Marine PTZ Dome Camera - Stainless Steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z200I66M+PTZ+camera.jpg',
		'',
		'',
		'',
		'This is a PTZ dome camera station, made in 316L stainless-steel, specifically designed for marine applications. It is equipped with the latest generation 2MP IP day/night camera.  It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.   ',
		'1,920.00',
		'Â£1,555.20',
		'',
		'',
	...
	(
		...
		'',
		'BSOS12F28II67',
		'Marine fixed camera with IR - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSOS12F28II67+camera.jpg\r\n',
		'Not available',
		'',
		'',
		'This is a high-quality 2MP HD resolution colour video camera with choice of fixed or vari-focal lens and 2MP or 8MP resolution. It includes integrated IR LEDs for operation at 0 lux at upto 30m.  The vari-focal lens is adjustable from 2.8 to 12.0 mm, to provide a horizontal field-of-view of up to 100 degrees.\nThe camera is housed in a stainless-steel bullet rated to IP67. It comes ready for mounting and requires only a PoE network connection (or 12vdc).  It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.  ',
		'614',
		'Â£528.04',
		'ArgesMarine',
		'',
	...
	(
		...
		'',
		'DSOS2Z200I67',
		'Marine PTZ dome camera with IR - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/DSOS2Z200I67+camera.jpg',
		'Not available',
		'',
		'',
		'This camera is a high-quality 2MP resolution colour/mono PTZ video camera with a 20x motorized zoom lens and auto-iris.   The camera supports multiple streams and resolutions in MJPEG or H.264 codec. The zoom lens is remotely adjustable from 4.7 to 94 mm, to provide a horizontal field-of-view of up to 55.5 degrees.  The camera is housed in a stainless-steel dome rated IP67. It comes ready for mounting and requires only PoE (or 12vdc/24vac optionally).  It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.  ',
		'1827',
		'Â£1,571.22',
		'ArgesMarine',
		'',
		...
		'Optical 20X Zoom lens',
		'2MP resolution',
		'PAN (360Â°Endless / Max. 380Â°/sec) / TILT (-10~190Â° / Max.380Â°/sec)',
		'',
		'Shock and Vibration Tested',
		'Fan and Heater',
		'AR Coated Polycarbonate Bubble Cover',
	...
	(
		...
		'',
		'BSOS2FV0I66',
		'Marine fixed flame detection camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSOS2FV0I66+camera.jpg\r\n',
		'Not available',
		'',
		'',
		'This specialist camera uses flame wave detection to detect flames at up to 30m distance.  It operates with a high-quality 2MP HD resolution colour video camera fitted with a vari-focal lens.adjustable from 2.8 to 12.0 mm to provide a horizontal field-of-view of up to 100 degrees.  It also includes an in-built IR illuminator.  The camera is housed in a stainless-steel bullet rated to IP66. It comes ready for mounting and requires only a PoE network connection (or 12vdc). It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.  ',
		'2048',
		'Â£1,761.28',
		'ArgesMarine',
		'',
	...
	(
		...
		'',
		'PSOA-3Z30-XI68',
		'Marine PTZ Camera - marine paint finish',
		'example location',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PSOA-3Z30-XI68+camera.png\r\n',
		'',
		'',
		'',
		...
		'Brushless stepper motors for resilience',
		'Intelligent, auto-PTZ tracking',
		'SD Card â€˜edgeâ€™ recording option',
		'',
		'',
		''
	),
	(
		...
		'',
		'BSOA-2Z4I-I67',
		'Fixed Bullet Marine Paint Finish Camera',
		'example location',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSOA-2Z4I-I67.png\r\n',
		'',
		'',
		'',
	...
	(
		...
		'',
		'PSOS-3Z30-XI68',
		'Marine PTZ Camera - stainless steel  construction',
		'example location',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PSOS-3Z30-XI68+camera.png\r\n',
		'',
		'',
		'',
	...
	(
		...
		'',
		'PHOS2Z200I66M',
		'Marine Optical PTZ Camera with wiper - Stainless Steel',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z200I66M+PTZ+camera.jpg',
		'Not available',
		'',
		'',
		'The camera is a PTZ camera station, made in 316L stainless-steel. It is equipped with the latest generation 2MP IP day/night camera and x20 motorised zoom lens. It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.   It is available with IR illuminator and thermal camera options.',
		'2,030.00',
		'Â£1,644.30',
		'',
		'',
	...
	(
		...
		'',
		'PHOS2Z20II66M',
		'Marine Optical PTZ Camera with IR - Stainless Steel',
		'',
		'',
		'Not available',
		'',
		'',
		'The camera is a PTZ camera station, made in 316L stainless-steel. It is equipped with the latest generation 2MP IP day/night camera and x20 motorised zoom lens with a high performance Infra-Red illuminator.  The IR lamp covers a distance upto 100m.  It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.   ',
		'2,030.00',
		'Â£1,644.30',
		'',
		'',
	...
	(
		...
		'thermal',
		'PHOTS2Z200I66M',
		'Marine thermal/Optical PTZ Camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z200I66+twin+PTZ+camera.jpg',
		'Not available',
		'',
		'',
	...
	(
		...
		'',
		'BHOS2F4II66',
		'Explosionproof bullet camera - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2F4II66+camera.png',
		'',
		'',
		'',
		'EX701PWC2',
	...
	(
		...
		'Explosionproof bullet camera - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS-4Z4I-I66+SS+camera.jpg',
		'',
		'',
		'paragon-security.co.uk/example-download',
		'AMZ-HD41-3-S',
		'',
		'',
		'IV&C',
	...
	(
		...
		'',
		'BHOA-4Z4I-I66',
		'Explosionproof bullet camera - aluminium  ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/oducts/cameras/prod-images/BHOA-4Z4I-I66+AL+camera.jpg\r\n',
		'',
		'',
		'paragon-security.co.uk/example-download',
		'AMZ-HD41-3-A',
	...
	(
		...
		'',
		'BHOS2Z360I68',
		'Explosionproof motorised x30 zoom bullet camera',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2Z360I68+camera.jpg\r\n',
		'',
		'',
		'',
		'GCXBN236Z',
	...
	(
		...
		'',
		'BHOS2ZV0I68',
		'Explosionproof fixed 2MP/8MP bullet camera\r\n',
		'',
	...
	(
		...
		'',
		'BHOS2Z18OI66',
		'Explosionproof Zoom Camera with wiper - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2Z18OI66+camera.jpg',
		'',
		'',
		'',
		'EX600PWY218',
	...
	(
		...
		'',
		'BHOS2Z36II68',
		'Explosionproof zoom camera with Motorized IR LED',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOS2Z36II68+camera.jpg\r\n',
		'',
		'',
		'',
		'GC-XDFN-236I',
	...
	(
		...
		'',
		'BHOTS2Z360I68',
		'Explosionproof Optical & thermal zoom camera',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHOTS2Z360I68+camera.jpg\r\n',
		'',
		'',
		'',
		'GC-XDFN-236T',
	...
	(
		...
		'thermal',
		'BHTS3F8OI66',
		'Explosionproof thermal Camera - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHTS3F8OI66+camera.jpg\r\n',
		'',
		'',
		'',
		'EX600PW8-R',
	...
	(
		...
		'',
		'DHOS2F4II66',
		'Explosionproof fixed dome camera - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/DHOS2F4II66M+camera.jpg\r\n',
		'',
		'',
		'',
		'EX2000PSB2',
	...
	(
		...
		'',
		'THOS-2F3I-I68',
		'Explosionproof fixed dome camera',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/THOS-2F3I-I68+dome+camera.jpg\r\n',
		'',
		'',
		'paragon-security.co.uk/example-download',
		'DS-2XE6126FWD-HS',
		...
		'1/2.8\" Progressive Scan CMOS',
		'2 mm, 2.8 mm, 4 mm, 6 mm lens options',
		'1920 Ã— 1080 2MP resolution',
		'120dB WDR',
		'Stainless steel 316L',
		'H.265, H.265+, H.264+, H.264',
		'Image enhancement: BLC, 3D DNR, HLC, defog, EIS',
		'Behaviour analyses, exception detections and face detection',
		'II 2 G D Ex db IIC T6 Gb/Ex tb IIIC T80â„ƒ Db IP68 Ex db IIC T6 Gb/Ex tb IIIC T80â„',
		'',
		'',
		'',
		'',
	...
	(
		...
		'',
		'PHOS2Z26OI66',
		'Explosionproof PTZ Dome Camera - Stainless Steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z26OI66+camera.jpg\r\n',
		'',
		'',
		'',
		'EX2000PSA226',
	...
	(
		...
		'',
		'PHOS2Z36II68',
		'Explosionproof PTZ with Motorized IR LED',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z36II68+camera.jpg\r\n',
		'',
		'',
		'',
		'GC-XDPN-236I',
	...
	(
		...
		'',
		'PHOS2Z20II66',
		'Explosionproof Optical PTZ Camera with IR - Stainless Steel',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z20II66+camera.png\r\n',
		'',
		'',
		'',
		'EX1000ZPPS220',
	...
	(
		...
		'',
		'PHOS2Z200I66',
		'Explosionproof Optical PTZ Camera with wiper - Stainless Steel',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS2Z200I66M+PTZ+camera.jpg\r\n',
		'',
		'',
	...
	(
		...
		'',
		'PHOS-2Z30O-I69',
		'Explosionproof PTZ Camera - Stainless Steel',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS-2Z300-I69+camera.jpg\r\n',
		'',
		'',
		'paragon-security.co.uk/PHOS-2Z30o-i69',
		'Maximus MPX series2',
		'',
		'',
		'Videotec',
		...
		'Certified for use in hazardous areas - ATEX (EN IEC 60079-0, EN 60079-1, EN 60079-31)',
		'Option for direct fiber optic connection',
		'Certified up to a temperature of +80Â°C',
		'Pole and corner mounting options',
		'',
		'',
		'',
	...
	(
		...
		'',
		'PHOTS2Z36II68',
		'Explosionproof PTZ Camera - Optical & thermal',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z36II68+camera.jpg\r\n',
		'',
		'',
		'',
		'GC-XDPN-236T',
	...
	(
		...
		'hazardous',
		'PHOTS2Z200I66',
		'Explosionproof thermal/Optical PTZ Camera - stainless steel ',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z200I66+twin+PTZ+camera.jpg\r\n',
		'',
		'',
	...
	(
		...
		'hazardous',
		'BHTS3F8OI66',
		'Explosionproof thermal Camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BHTS3F8OI66+camera.jpg\r\n',
		'',
		'',
	...
	(
		...
		'',
		'BSTAIF80I67',
		'thermal fixed camera (IP67)',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSTAIF80I67+Thermal+camera.png\r\n',
		'',
		'',
		'',
	...
	(
		...
		'hazardous',
		'PHOTS2Z20OI66',
		'Explosionproof thermal/Optical PTZ Camera - stainless steel construction',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z200I66+twin+PTZ+camera.jpg',
		'',
		'',
	...
	(
		...
		'',
		'BSOA8FVII67',
		'External bullet camera with motorised vari-focal lens (IP67)',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSOA8FVII67+BULLET+camera.jpg\r\n',
		'',
		'',
		'',
		'IB9391-EHT bullet 8MP/4/2',
		'',
		'',
		'Vivotek',
		'',
		...
		'Smart Motion Detection to Reduce False Alarms',
		'Weather-proof IP67, Vandal-proof IK10 and NEMA 4X-rated Housing',
		'-40Â°C ~ 60Â°C Wide Temperature Range for Extreme Weather Conditions',
		'',
		'',
		'',
		'',
	...
	(
		...
		'',
		'DSOA8FVII67',
		'External dome camera with motorised vari-focal lens (IP67)',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/DSOA8FVII67+DOME+camera.jpg\r\n',
		'',
		'',
		'',
		'FD9392-EHTV-O dome 8MP/4/2',
		'',
		'',
		'Vivotek',
		'',
	...
	(
		...
		'',
		'DSOA12F1II66',
		'Fisheye camera 12MP 360 degree',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/DSOA12F1II66+FISHEYE+camera.jpg\r\n',
		'',
		'',
		'',
		'FE9391-EHV-v2 fisheye',
		'',
		'',
		'Vivotek',
		'',
	...
	(
		...
		'ANPR camera',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/BSOP-2Z4I-I67+Standard+ANPR+Camera.jpg',
		'',
		'',
		'paragon-security.co.uk/example-download',
		'iDS-2CD7A26G0/P-IZHS',
		'',
		'',
		'Hikvision',
		'',
	...
	(
		...
		'',
		'PSOA5Z30II66',
		'External 5MP PTZ camera',
		'',
		'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PSOA5Z30II66+PTZ+CAMERA.jpg\r\n',
		'',
		'',
		'',
		'SD9384-EHL PTZ 2MP/5MP',
		'',
		'',
		'Vivotek',
		'',
		'25 fps @ 2560x1920',
		'30x Optical Zoom, Auto Focus',
		'360Â° Continuous Pan, -20Â° to 90Â° (auto flip) Tilt',
		'200M IR with Smart IR',
		'Weather-proof IP66-rated, Vandal-proof IK10 and NEMA 4X-rated Housing',
		'-40Â°C ~ 60Â°C Wide Temperature Range for Extreme Weather Conditions',
		'EIS (Electronic Image Stabilization) for Image Stability',
...
VALUES (
		...
		'Dimensions Monitor+Stand',
		'Colour',
		'Case & Stand Material',
		'VESA Mounting Pattern (mm)',
		'Base/Stand Included',
		'Base Tilt Angle',
		'Weight Cabinet Only (kg)',
		'Weight Cabinet+Base Stand(Ib/kg)',
	...
	(
		...
		'Yes',
		'16:09',
		'OSD selectable 16:9 or 4:3',
		'00:00',
		'3000 :1SCR',
		'5 (GTG)',
		'178°x 178°/CR＞10',
		'HDMI up to 1920 x1080',
		'VGA up to 1920x1080, BNC CVBS looping',
		'1x3.5mm mini-jack',
		'2 x 3',
		'＜0.5',
		'32W Typical',
		...
		'-20°C~50°C / -4°F~122°F',
		'10~90%',
		'CE/FCC/ROHS/HDMI/UL/WEEE/REACH'
	),
	(
		'MONUHD43',
		'UHD',
	...
	(
		...
		'',
		'1920x1080',
		'640 x 480; 800 x 600; 1024 x 768; 1280 x 1024; 1366 x 768; 1920 x 1080',
		'640 x 480; 800 x 600; 1024 x 768; 1280 x 1024; 1366 x 768; 1920 x 1080',
		'60',
		'16.7',
		'250',
		...
		'＜0.5',
		'19W Typical',
		'18.52inchx11.1inchx1.88inch / 470.4mmx282mmx47.7mm',
		'18.52inchx13.43inchx5.87inch/ 470.4mmx341.2mmx149.1mm',
		'Matte black',
		'Plastic',
		'100 x 100',
		'Yes',
	...
	(
		...
		'',
		'1920x1080',
		'640x480;800x600;1024x768;1280x1024;1366x768;1920x1080',
		'60',
		'16.7',
		'250',
		'Yes',
		...
		'＜0.5',
		'20W Typical',
		'19.96inchx12.16inchx1.9inch / 507mmx309.1mmx48.5mm',
		'19.96inchx14.57inchx5.87inch / 507mmx370.2mmx149mm',
		'Matte black',
		'Plastic',
		'100 x 100',
		'Yes',
	...
	(
		...
		'Full HD',
		'23.6',
		'20.52inch*11.54inch / 521mm*293mm',
		'LED',
		'0.2715x0.2715',
		'1920x1080',
		'',
		...
		'＜0.5',
		'25W Typical',
		'21.88inchx13.28inchx2inch / 555.9mmx337mmx50.8mm',
		'21.88inchx15.69inchx5.87inch / 555.9mmx398.5mmx149mm',
		'Matte black',
		'Plastic',
		'100 x 100',
		'Yes',
	...
	(
		...
		'Full HD',
		'31.5',
		'27.5inch*15.47inch / 698.5mm*393mm',
		'LED',
		'0.36x0.36',
		'1920x1080',
		...
		'＜0.5',
		'50W Typical',
		'28.8inchx17inchx1.9inch / 731.4mmx432.5mmx49mm',
		'28.8inchx19.6inchx6.3inch / 731.4mmx497.5mmx160mm',
		'Matte black',
		'Metal + Aluminum (removable stand)',
		'200 x 200',
		'Yes',
		'-5°~15°',
		'21.1Ibs / 9.6kg',
	...
	(
		...
		'',
		'110W',
		'38.3\" x 22.3\" x 3.7\" (972.5x566x94.2mm)',
		'',
		'',
		'',
		'',
	...
	(
		...
		'0.30x0.30',
		'1366 x 768',
		'640x480;800x600;1024x768;1280x1024;1366 x 768',
		'640x480;800x600;1024x768;1280x1024;1366 x 768',
		'60',
		'16.7',
		'250',
		...
		'OSD selectable 16:9 or 4:3',
		'768',
		'1000 :1SCR or 1,000,000:1DCR',
		'5(GTG)',
		'170°x 150°/CR＞10',
		'HDMI up to 1366 x 768',
		'VGA up to 1366 x 768',
		'1x3.5mm mini-jack',
		'2 x 3',
		'＜0.5',
		'18W Typical',
	...
	(
		...
		'Yes',
		'16:09',
		'OSD options: Full/4:3/Over Scan',
		'1080',
		'1000:1 SCR',
		'8 (GTG)',
		'178°x 178°/CR＞10',
		...
		'＜0.5',
		'20W Typical',
		'21.3”x12.6”x1.7”(541.4x321.8x43.8mm)',
		'21.3”x16.1”x7.5”(541.4x409x190mm)',
		'Matte black',
		'Plastic',
		'100 x 100',
		'Yes',
	...
	(
		...
		'＜0.5',
		'26W Typical',
		'24.1”x14.3”x1.9”(614.4x363.5x49.5mm)',
		'24.1”x17.7”x7.5”(614.4x450.7x190mm)',
		'Matte black',
		'Plastic',
		'100 x 100',
		'Yes',
	...
	(
		...
		'',
		'Backlight DLED',
		'0.02” x 0.02” (0.510mmx0.510mm)',
		'1366x768',
		'',
		'',
		'',
		'',
		'Typ.:400cd/m² (NITS) Center Luminance of',
		'',
		'',
		'',
		'',
		...
		'',
		'75W',
		'28.8” x 17.1” x 3.2” (732x434x80.9mm) ',
		'',
		'',
		'',
		'',
...
VALUES (
	...
	(
		...
		'',
		'',
		'Experience Full HD CCTV security monitoring. Designed specifically to run for 24 hours a day, 7 days a week, 365 days a year and compatible with BNC, HDMI, VGA, DVI and Audio.  These monitors combine extremely high contrast and low power consumption to be the perfect deploy-anywhere option. 20, 22, 24, 27, 32 and 43’’ Full HD LED screen size options.',
		'20, 22, 24, 32 and 43’’ Full HD LED screen size options',
	...
	(
		...
		'',
		'',
		'Experience HD CCTV security monitoring. Designed specifically to run for 24 hours a day, 7 days a week, 365 days a year and compatible with HDMI, VGA, DVI and   19, 24, 27 and 32\" HD LED screen size options.',
		'19, 24, 27 and 32\" HD LED screen size options',
...
INSERT INTO `nvr_adv_features_1` (
		`product_code`,
		`VCA Counting Solution`,
		`VCA Event Search`,
		`Smart Search II`,
...
INSERT INTO `nvr_deep_search` (
		`product_code`,
		`Object Search`,
		`Scene Search`,
		`Attribute Search`
	)
VALUES ('NVR0400TB', 'n/a', 'n/a', 'n/a'),
	('NVR0800TB', 'n/a', 'n/a', 'n/a'),
	(
		'NVR1600TB',
		'People, Vehicle',
		'Line crossing, Intrusion, Loitering',
		'People: Gender, Age, Clothing Color, Accessories'
	),
	(
		'NVR3200TB',
		'People, Vehicle',
...
INSERT INTO `nvr_display` (
		`product_code`,
		`LiveView Display Channels`,
		`LiveView Display Specs`,
		`Video Output`,
		`Display Resolution`,
		`Fisheye Dewarp`,
		`Warp (web)`,
...
VALUES (
		'NVR0400TB',
		'4 Channels',
		'Multi-Layout Display: 1x1, 2x2, 3V',
		'HDMI x1, VGA x1',
		'3840x2160, 1920x1080, 1280x720',
		'Local: 1O, 1R, 1P, 1O3R, 1O8R, 1P3R',
		'Web: 1O, 1R, 1P',
		'Direction Control, Home, Iris, Preset, Patrol (Group)'
	),
	(
		'NVR0800TB',
		'8 Channels',
		'Multi-Layout Display: 1x1, 2x2, 3x3, 1P+3,2P+3,1M+5, 1P+6, 3V',
		'HDMI x1, VGA x1',
		'3840x2160, 1920x1080, 1280x720',
		'Local: 1O, 1R, 1P, 1O3R, 1O8R, 1P3R',
		'Web: 1O, 1R, 1P',
	...
	(
		'NVR1600TB',
		'16 Channels',
		'Multi-Layout Display: 1x1, 2x2, 3x3, 1P+3,2P+3,1M+5, 1P+6, 3V,1M+12, 4x4',
		'HDMI x1, VGA x1',
		'3840x2160, 1920x1080, 1280x720',
		'Local: 1O, 1R, 1P, 1O3R, 1O8R, 1P3R',
		'Web: 1O, 1R, 1P',
	...
	(
		'NVR3200TB',
		'32 Channels',
		'Multi-Layout Display: 1x1, 2x2, 3x3, 1P+3,2P+3,1M+5, 1P+6, 3V,1M+12, 4x4, 1M+31',
		'HDMI x1, VGA x1',
		'3840x2160, 1920x1080, 1280x720',
		'Local: 1O, 1R, 1P, 1O3R, 1O8R, 1P3R',
		'Web: 1O, 1R, 1P',
...
VALUES (
		...
		'DC 48V/2A',
		'Max. 96 W',
		'263 (W) x 247 (D) x 43 (H) mm',
		'2.35 kg (without HDD)',
		'0°C ~ 40°C (32°F ~ 104°F)',
		'0 ~ 95%',
		'CE, FCC, VCCI, C-Tick, UL, CB, BSMI, BIS'
	),
	(
		'NVR0800TB',
		'100-240V AC, 50/60Hz',
		'Max. 175 W',
		'366 (W) x 320 (D) x 46 (H) mm',
		'2.5 kg (without HDD)',
		'0°C ~ 40°C (32°F ~ 104°F)',
		'0 ~ 95%',
		'CE, FCC, VCCI, C-Tick, UL, CB, BSMI, BIS'
	...
	(
		...
		'100-240V AC, 50/60Hz',
		'Max. 300 W',
		'432 (W) x 421 (D) x 66 (H) mm',
		'4.6 kg (without HDD)',
		'-10°C ~ 55°C (14°F ~ 131°F)',
		'0 ~ 95%',
		'CE, LVD, FCC, VCCI, C-Tick, UL, CB, BSMI, BIS'
	),
	(
		'NVR3200TB',
		'100-240V AC, 50/60Hz',
	...
	(
		...
		'100-240V AC, 50/60Hz',
		'Max. 250 W',
		'342 (W) x 409 (D) x 96 (H) mm',
		'5.12 kg (without HDD)',
		'5°C ~ 35°C (41°F ~ 95°F)',
		'0 ~ 95%',
		'CE, FCC, VCCI, C-Tick, UL, CB, BSMI'
	);
-- --------------------------------------------------------
--
...
VALUES (
	...
	(
		'SMW00TB',
		'Security Management Workstation',
		'',
		'',
		'',
		'',
...
INSERT INTO `nvr_network` (
		`product_code`,
		`Ethernet`,
		`Network Throughput Input/Output Total`,
		`PoE`,
		`PoE Management`,
		`Protocols`
	)
VALUES (
		...
		'88 Mbps',
		'802.3at/af compliant PoE ports x 4 (Total Max. 200 W)',
		'Supported',
		'IPv4, IPv6, TCP/IP, HTTP, HTTPS, UPnP, RTSP/RTP/RTCP, SMTP, FTP, DHCP, NTP, DNS, DDNS'
	),
	(
		'NVR0800TB',
		'10/100/1000Mbps Ethernet (RJ-45) x2',
		'88 Mbps',
		'802.3at/af compliant PoE ports x 8 (Total Max. 200 W)',
		'Supported',
		'IPv4, IPv6, TCP/IP, HTTP, HTTPS, UPnP, RTSP/RTP/RTCP, SMTP, FTP, DHCP, NTP, DNS, DDNS'
	),
	(
		...
		'10/100/1000Mbps Ethernet (RJ-45) x2',
		'224 Mbps',
		'802.3at/af compliant PoE ports x 16 (Total Max. 200 W)',
		'Supported',
		'IPv4, IPv6, TCP/IP, HTTP, HTTPS, UPnP, RTSP/RTP/RTCP, SMTP, FTP, DHCP, NTP, DNS, DDNS'
	),
	(
...
INSERT INTO `nvr_playback` (
		`product_code`,
		`Playback Display Channels`,
		`Display Spec`,
		`Playback Control`,
		`Video Search`,
		`Thumbnail Explorer (Storyboard)`,
		`Snapshot`,
		`Video Clip Export`
	)
VALUES (
		'NVR0400TB',
		'4 Channels',
		'Multi-Layout Display: 1x1, 2x2, 1P+3, 1V+3',
		'Regular (play, pause, stop), rewind, next/previous frame, speed control, calendar, event, timeline, timeline scale, thumbnail (storyboard)',
		'By calendar, date/time, and alarm',
		'Listing the thumbnail of recorded video (Max. 2-CH)',
		'JPEG',
		'Supported'
	),
	(
	...
	(
		'NVR1600TB',
		'4 Channels',
		'Multi-Layout Display: 1x1, 2x2, 1P+3, 3V',
		'Regular (play, pause, stop), rewind, next/previous frame, speed control, calendar, event, timeline, timeline scale, thumbnail (storyboard)',
		'By calendar, date/time, and alarm',
		'Listing the thumbnail of recorded video (Max. 2-CH)',
		'JPEG',
...
INSERT INTO `nvr_recording` (
		`product_code`,
		`Recording Time (sec.) Pre`,
		`Post`,
		`Recording Stream`,
...
INSERT INTO `nvr_remote` (
		`product_code`,
		`Mobile/Tablet App`,
		`Web Browser`
	)
VALUES ('NVR0400TB', 'iViewer (Android & iOS)', 'Chrome'),
...
VALUES (
		'NVR0400TB',
		'ONVIF Profile S',
		'Motion Detection, Smart VCA Event, Cyber Attack, PIR Detection, Tampering Detection, Camera DI/DO, Camera Disconnected, Disk Failure, Disk Full, NVR DI/DO, PoE error, Fan error',
		'Record, Email (Text), Email (Snapshot), FTP, Buzzer, ePTZ Control (Go to Preset), NVR DO, Camera DO, VIVOCloud APP Notification',
		'User level: administrator, regular user',
		'System, recording, user, error',
		'Time Zone, Manual, Automatic Sync NTP, Daylight Saving Time',
		'Czech, English, French, German, Italian, Japanese, Korean, Portuguese, Polish, Russian, Spanish, Simplified Chinese, Traditional Chinese, Arabic'
	),
	(
		'NVR0800TB',
		'ONVIF Profile S',
...
VALUES (
	...
	(
		...
		'Up to 8192x8192',
		'H.265/H.264:',
		'3840x2160 @ 90 fps (3-CH)',
		'1920x1080 @ 360 fps (12-CH)'
	),
	(
		'NVR3200TB',
		'H.265, H.264, MJPEG',
	...
	(
		...
		'Up to 8192x8192',
		'H.265/H.264:',
		'H264 1920x1080 @ 540 fps ',
		'H265 1920x1080 @ 270 fps '
	),
	(
		'NVR12800TB',
		'H.265, H.264, MJPEG',
	...
	(
		...
		'Up to 8192x8192',
		'H.265/H.264:',
		'H264 1920x1080 @ 540 fps; H265 1920x1080 @ 270 fps',
		'1920x1080 @ 360 fps (12-CH)'
	);
-- --------------------------------------------------------
--
...
VALUES (
	...
	(
		'PHOS2Z260I66M',
		'360Â°',
		'Horizontal rotation speedï¼š0.1Â°-250Â°/s, rotation speed can be',
		'-18Â°-90Â°',
		'Vertical rotation speedï¼š0.1Â°-150Â°/s, rotation speed can be set; VerticalpresetÂ  rotation speedï¼',
		'',
		'',
		''
	),
	(
		'DSOS2Z200I67',
		'Pan: 360Â° endless, Tilt: -10Â°-+19',
		'Pan/tilt speed: max. 380Â° / sec',
		'',
		'',
		'Preset: 256, Tour: 8, Pattern: 8',
		'',
		''
	),
	('PSOA-3Z30-XI68', '', '', '', '', '', '', ''),
	...
	(
		'PHOS2Z200I66M',
		'HorizontalÂ ï¼š0ï½ž360Â°Vertical: Â',
		'0.1Â°/S~40Â°/sÂ ',
		'',
		'0.1Â°/S~40Â°/s',
		'300',
	...
	(
		'PHOTS2Z200I66M',
		'HorizontalÂ ï¼š0ï½ž360Â°',
		'',
		'Vertical: Â Â ï¼šÂ±90Â°',
		'',
		'',
		'',
		''
	...
	(
		'PHOS2Z20II66',
		'HorizontalÂ ï¼š0ï½ž360Â°Vertical: Â',
		'HorizontalÂ ï¼š0.1Â°/S~40Â°/sÂ Vertical: Â Â ï¼š0.1Â°/S~40Â°/s',
		'',
		'',
		'300',
		'',
...
VALUES (
	...
	(
		...
		'Dia 83  117L   110H',
		'',
		'1pcs M20*1.5 output(original G1/2)',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'BSOS12F28II67',
	...
	(
		...
		'Dia 157.5   147.5H',
		'',
		'1pcs M20*1.5(original 1*Â G1/2â€³ )',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'BHOS2Z18OI66M',
		...
		'80kpaï½ž106 k',
		'',
		'Î¦162Ã—457.5mm(length )',
		'Î¦90.5Ã—309.5mm(length',
		'2pcs M25*1.5 output (original G3/4â€³ )',
		'Wall hanging, fixed bracket , pedestal base, PTZ'
	),
	(
		'BHTS3F8OI66M',
	...
	(
		...
		'',
		'Approx. 4.3Kg',
		'185(W)x160(H)x185(D)mm',
		'',
		'One 3/4\" NPT conduit entries',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'PSOA-3Z30-XI68',
		'Aluminuim',
		'',
		'-40 to +70 deg C (white or grey paint finish)',
		'',
		'',
	...
	(
		...
		'',
		'',
		'14kg without lamps; 18kg with lamps. ',
		'313W x 386H x 214D',
		'',
		'',
		'Wall hanging, fixed bracket , pedestal base'
	...
	(
		...
		'',
		'Approx. 10Kg',
		'244(W)x237.5(H)x270(D)mm',
		'',
		'Two M25 conduit entries',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		'BHOTS2Z360I68',
	...
	(
		...
		'',
		'',
		'-50Â°C ~ 60Â°C (-58Â°F ~ 140Â°F)',
		'90%',
		'',
		'2,115 g',
		'121 x 121 x 471.2 mm (with junction box)',
		'',
		'',
		'Wall hanging, fixed bracket , pedestal base'
	),
	...
	(
		...
		'',
		'',
		'-50Â°C ~ 50Â°C (-58Â°F ~ 122Â°F) (IR on)',
		'95%',
		'',
		'2.2 kg',
		'121 x 121 x 394 mm (w/ junction box)',
		'',
		'',
		'Wall hanging, fixed bracket , pedestal base'
	),
	(
		...
		'',
		'',
		'-50Â°C ~ 60Â°C (-58Â°F ~ 140Â°F) (IR off)',
		'90%',
		'',
		'1,343 g',
		'Ã˜ 155 x 138 mm',
	...
	(
		...
		'',
		'',
		'-40Â°C ~ 50Â°C (-40Â°F ~ 122Â°F) (IR on)',
	...
	(
		...
		'',
		'',
		'-40Â°C ~ 60Â°C (-40Â°F ~ 140Â°F) (IR on)',
...
VALUES (
	...
	(
		...
		'',
		'12VDC / POE',
		'IR OFF : 150mA(MAX) / IR ON : 400mA(MAX)'
	),
	(
		'BSOA-2Z4I-I67',
		'Ethernet RJ-45(10/100/1000Base-T)',
	...
	(
		...
		'',
		'24VDC',
		'50W(80W with water tank operation)'
	),
	(
		'PHOS2Z20II66M',
		'Ethernet RJ-45(10/100/1000Base-T)',
	...
	(
		...
		'RJ45',
		'',
		'1 alarm input, 1 relay, 1 RS485',
		'',
		'24VDC Option 110VAC/220VAC',
		'60W(Max. 80W with water tank and IR LED operation)'
	),
	(
		'BHOTS2Z360I68',
		'',
	...
	(
		...
		'1 IN; 1 OUT',
		'',
		'12 VDC; PoE (802.3af, 36V to 57V)',
		'0.8 A, max. 10 W PoE 0.3 A to 0.2 A, max. 12.5 W'
	),
	(
		'PHOS2Z26OI66',
		'',
	...
	(
		...
		'Yes',
		'Yes',
		'Audio detection, camera tampering detection, cybersecurity events (brute force attack event, cyberattack event, quarantine event), digital input, manual trigger, motion detection, periodical trigger, recording notification, SD card life expectancy, shock detection, system boot',
		'',
		'AC 24V, DC 12V, IEEE 802.3at PoE Class 4',
		'PoE: Max. 14 W'
	),
	(
		'BHOTS2Z360I68',
	...
	(
		...
		'Audio detection, camera tampering detection, cybersecurity events (brute force attack event, cyberattack event, quarantine event), digital input, manual trigger, motion detection, periodical trigger, recording notification, SD card life expectancy, shock detection, system boot',
		'',
		'IEEE 802.3at Class 4 PoE, DC 12V, AC 24V',
		'PoE : Max. 24.8 W'
	),
	(
		'DSOA8FVII67',
		...
		'',
		'',
		'IEEE 802.3af Class3 PoE; 12vdc; 24vac',
		'Max. 25 W'
	),
	(
		'DSOA12F1II66',
	...
	(
		...
		'',
		'',
		'Audio detection, camera tampering detection, cybersecurity events (brute force attack event, cyberattack event, quarantine event), digital input, manual trigger, motion detection, periodical trigger, recording notification, SD card life expectancy, smart tracking advanced trigger, system boot, preset reached',
		'',
		'AC 24V, DC 48V, IEEE 802.3 bt Class 6 PoE',
		'PoE: Max. 51W/26W (IR on/off)'
	);
-- --------------------------------------------------------
--
