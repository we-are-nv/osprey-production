...
--
-- Host: sql
-- Generation Time: Feb 13, 2023 at 05:12 PM
...
('STXXXXXVXXXX ', 'NVR Hard Disk', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/STXXXXXVXXXX+HardDisk.png', 'Not available', '', '', '', '', 'Seagate', '', 'Available from 1TB to 20TB capacity', 'ImagePerfect™ firmware is designed to ensure seamless video footage capture in 24x7 surveillance workloads that record video from 64 HD cameras.', 'SkyHawk Health Management actively helps protect your surveillance storage by focusing on prevention, intervention, and recovery options.', 'RapidRebuild™ provides 3x faster volume rebuilds over traditional RAID rebuilds.', 'Unparalleled data protection with included 3-year Rescue Data Recovery Services plan, helping protect important video data with Seagate\'s in-house data recovery services', '', 'RV sensors built in allow drives to maintain performance in multi-bay systems, giving you the flexibility to scale your systems when more storage is needed.', 'ATA streaming support enables recordings from up to 64 HD cameras for smooth, uninterrupted footage.', '1M hours MTBF, 3-year limited warranty represents an improved total cost of ownership (TCO) with reduced maintenance costs.', 'Lower power consumption means a reduction in heat emissions, which improves reliability in surveillance solutions. ', 'Tarnish-resistant components help protect drives from environmental elements, increasing field reliability.', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `disk_nvr_size_specs`
--

CREATE TABLE `disk_nvr_size_specs` (
  `product_code` varchar(13) DEFAULT NULL,
  `size (TB)` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Dumping data for table `disk_nvr_size_specs`
--

INSERT INTO `disk_nvr_size_specs` (`product_code`, `size (TB)`) VALUES
('ST20000VE002 ', 20),
('ST18000VE002 ', 18),
('ST16000VE002 ', 16),
('ST12000VE001 ', 12),
...
INSERT INTO `housings_certs` (`product_code`, `Impact protection`, `Salt fog resistance`, `Corrosion testing`, `Vibration testing`, `Ingress Protection`, `European/US/EMC`, `Marine`, `Hazardous Area`) VALUES
...
INSERT INTO `housings_features` (`product_code`, `feature 1`, `feature 2`, `feature 3`, `feature 4`, `feature 5`, `feature 6`, `feature 7`, `feature 8`, `feature 9`, `feature 10`, `feature 11`, `feature 12`, `feature 13`, `feature 14`, `feature 15`, `feature 16`, `features_concat`) VALUES
...
INSERT INTO `housings_movement` (`product_code`, `Pan range`, `Dimensions - external (mm)`, `Pan speed`, `Tilt range`, `Tilt speed`, `Pre-sets`, `Pre-set tours`, `Motion tracking`) VALUES
('BSOA0000067', '', '', '', '', '', '', '', ''),
('BSOA000W067', '', '', '', '', '', '', '', ''),
('BHTS0000066', '', '', '', '', '', '', '', ''),
('DHOS0000066', '', '', '', '', '', '', '', ''),
...
INSERT INTO `housings_optics` (`product_code`, `IR Illumination range`, `Window`) VALUES
...
INSERT INTO `housings_physical` (`product_code`, `Material`, `Colour`, `Operating temp`, `Relative humidity`, `Atmospheric pressure`, `Weight (kg)`, `Dimensions - external (mm)`, `Dimensions - internal (mm)`, `Cable entry`, `Mounting options`) VALUES
...
('BHTS0000066', '316L stainless steel', '', '-40°C ~ 60°C (-40°F ~ 140°F)', '', '', '', '380mm*143mm*151mm', 'Φ108x300mm(length', '2pcs M25*1.5 output(original G3/4)', 'Wall hanging, fixed bracket , pedestal base'),
...
('BHOS0000066', '316L stainless  steel', '', '-40℃~60℃', '≤95%(+25°C)', '80kpa~106 kpa', '', 'Φ162x457.5mm(length )', 'Φ90.5x309.5mm(length )', '2pcs M25*1.5 output (original G3/4″ )', 'Wall hanging, fixed bracket , pedestal base, PTZ'),
...
INSERT INTO `housings_power` (`product_code`, `Power supply`, `Power consumption`) VALUES
...
(17, 'PTZ', 'marine', '', 'PHOS2Z20II66M', 'Marine Optical PTZ Camera with IR - Stainless Steel', '', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOS-2Z20-II66M+Marine+Optical+PTZ+with+IR.png', 'Not available', '', '', 'The camera is a PTZ camera station, made in 316L stainless-steel. It is equipped with the latest generation 2MP IP day/night camera and x20 motorised zoom lens with a high performance Infra-Red illuminator.  The IR lamp covers a distance upto 100m.  It is designed for use in onshore, offshore, marine and heavy industrial environments including passenger ships & commercial vessels.   ', '2,030.00', 'Â£1,644.30', '', '', '', '', '', 'Marine 316L grade stainless steel', '20x zoom lens', 'IR distance:100M', 'Support ONVIF, HIKVISION, DAHUA', 'AC85V-260V', 'Suited to strong corrosive environments. Anti-corrosion, waterproof.', 'Smart windscreen wiper', 'Supports digital wide dynamic,  3D-DNR, low bit rate', 'Windows glass surface process by nano technology . Good light transmittance. ', 'Low power consumption', 'Suited to harsh environmental conditions including petrochemicals, mining, military, medicine, oil & gas, marine, drilling platforms, food processing and storage, offshore etc.', '', ''),
(18, 'PTZ', 'marine', 'thermal', 'PHOTS2Z200I66M', 'Marine thermal/Optical PTZ Camera - stainless steel construction', '', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z200I66+twin+PTZ+camera.jpg', 'Not available', '', '', 'This camera is a rugged corrosion-proof dual-head PTZ station designed for use in onshore, offshore, marine and heavy industrial environments. The combination of thermal imaging and daylight cameras facilitates 24/7 remote camera surveillance. The daylight camera controls the movement of the camera (PTZ). The camera\'s large germanium window suits all thermal modules from 8 to 100 mm. ', '7,750.00', 'Â£6,277.50', '', '', '', '', '', 'Smart windscreen wiper option', 'Marine 316L grade stainless steel', 'Suited to strong corrosive environments. Anti-corrosion, waterproof.', 'Windows glass surface process by nano technology . Good light transmittance. ', 'Low power consumption', '', '', '', '', '', 'Suited to harsh environmental conditions including petrochemicals, mining, military, medicine, oil & gas, marine, drilling platforms, food processing and storage, offshore etc.', '', ''),
...
(41, 'PTZ', 'thermal', 'hazardous', 'PHOTS2Z20OI66', 'Explosionproof thermal/Optical PTZ Camera - stainless steel construction', '', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/PHOTS2Z200I66+twin+PTZ+camera.jpg', '', '', '', 'EX1000ZPPST50D220-R', '7,750.00', 'Â£6,277.50', 'Kaiuxan', '', 'thermal Camera certified for use in hazardous environments', 'ATEX Zone 1&2 / 21&22', 'Class I Division 1&2 / Class II Division 1&2 and all the rest except zone 0.', 'Smart windscreen wiper option', 'Marine 316L grade stainless steel', 'Suited to strong corrosive environments. Anti-corrosion, waterproof.', 'Windows glass surface process by nano technology . Good light transmittance. ', 'Low power consumption', '', '', '', '', '', 'Suited to harsh environmental conditions including petrochemicals, mining, military, medicine, oil & gas, marine, drilling platforms, food processing and storage, offshore etc.', '', ''),
...
('MONUHD43', 'UHD', 'UHD', '43', '', '', '0.2451mmx0.2451mm', '3840x2160', '', '', '', '', '260', '', '', '', '', '1000 :1SCR', '8(GTG)', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 5W', '', '<83W', '970.2x558.8x83.8mm', '', '', '', '', 'Yes', '', '7.7', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH'),
('MONUHD49', 'UHD', 'UHD', '49', '', '', '0.2797mmx0.2797mm', '', '', '', '', '', '260', '', '', '', '', '1000 :1SCR', '8(GTG)', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 5W', '', '<94W', '1107.4x645.1x88.9mm', '', '', '', '', 'Yes', '', '10', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH'),
('MONUHD55', 'UHD', 'UHD', '55', '', '', ' 0.3151mmx0.3151mm', '', '', '', '', '', '260', '', '', '', '', '1000 :1SCR', '8(GTG)', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 5W', '', '<165W', '1244.6x729x94mm', '', '', '', '', 'Yes', '', '13.9', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH'),
('MONUHD65', 'UHD', 'UHD', '65', '', '', ' 0.372mmx0.372mm', '', '', '', '', '', '260', '', '', '', '', '1000 :1SCR', '8(GTG)', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 5W', '', '<189W', '1460.5x843.2x90.5mm', '', '', '', '', 'Yes', '', '17.8', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH'),
...
('MONFHD43', 'Full HD', 'Full HD', '43', '', 'DLED', '0.02” x 0.02” (0.4902mmx0.4902mm)', '1920x1080', '', '', '', '', '500cd/m² (NITS)', '', '', '', '', '1200 :1SCR', '', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 10W', '', '110W', '38.3\" x 22.3\" x 3.7\" (972.5x566x94.2mm)', '', '', '', '', 'Yes', '', '7.45', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH'),
...
('MONHD24', 'HD', 'HD', '23.8', '20.74x11.67(527.04x296.46)', 'LED', '0.2745x0.2745', '1920x1080', '720x400;640x480;800x600;1024x768;1280x1024;1366x768;1920x1080', '720x400;640x480;800x600;1024x768;1280x1024;1366x768;1920x1080', '60', '16.7', '250', 'Yes', '16:09', 'OSD options: Full/4:3/Over Scan', '1080', '1000:1 SCR', '8 (GTG)', '178°x 178°/CR＞10', 'HDMI up to 1920 x 1080', 'VGA up to 1920 x 1080', '1x3.5mm mini-jack', '2x2', '＜0.5', '20W Typical', '21.3”x12.6”x1.7”(541.4x321.8x43.8mm)', '21.3”x16.1”x7.5”(541.4x409x190mm)', 'Matte black', 'Plastic', '100 x 100', 'Yes', '-5°~15°', '6.9Ibs(3.15 Kg)', '7.7Ibs(3.5 Kg)', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '-20°C~50°C / -4°F~122°F', '10~90%', 'CE/FCC/ROHS/HDMI/UL/WEEE/REACH'),
('MONHD27', 'HD', 'HD', '27', '23.53x13.24(597.888x336.312)', 'LED', '0.3114x0.3114', '1920x1080', '720x400;640x480;800x600;1024x768;1280x1024;1366x768;1920x1080', '720x400;640x480;800x600;1024x768;1280x1024;1366x768;1920x1080', '60', '16.7', '250', 'Yes', '16:09', 'OSD options: Full/4:3/Over Scan', '1080', '1000:1 SCR', '8 (GTG)', '178°x 178°/CR＞10', 'HDMI up to 1920 x 1080', 'VGA up to 1920 x 1080', '1x3.5mm mini-jack', '2x2', '＜0.5', '26W Typical', '24.1”x14.3”x1.9”(614.4x363.5x49.5mm)', '24.1”x17.7”x7.5”(614.4x450.7x190mm)', 'Matte black', 'Plastic', '100 x 100', 'Yes', '-5°~15°', '9.7Ibs(4.4 Kg)', '10.5Ibs(4.8 Kg)', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '-20°C~50°C / -4°F~122°F', '10~90%', 'CE/FCC/ROHS/HDMI/UL/WEEE/REACH'),
('MONHD32', 'HD', 'HD', '32', '', 'Backlight DLED', '0.02” x 0.02” (0.510mmx0.510mm)', '1366x768', '', '', '', '', 'Typ.:400cd/m² (NITS) Center Luminance of', '', '', '', '', 'Typ.:1100:1', '9ms (GTG)', '', '', 'VGA up to 1920x1080, BNC CVBS looping', '1x3.5mm mini-jack', '2 x 10W', '', '75W', '28.8” x 17.1” x 3.2” (732x434x80.9mm) ', '', '', '', '', 'Yes', '', '4.5', '', 'AC 100-240V~50/60Hz 1.1A', '0°C~40°C / 32°F~104°F', '', '10~90%', 'CE/FCC/WEEE/REACH');
...
INSERT INTO `monitors_types` (`monitor_type`, `type`, `image`, `technical_image`, `description`, `feature 1`, `feature 2`, `feature 3`, `feature 4`, `feature 5`, `feature 6`, `feature 7`, `feature 8`, `feature 9`, `feature 10`, `feature 11`, `ID`) VALUES
('UHD 4k Monitors', 'UHD', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/uhd4k.png', '', 'Experience True 4K CCTV security monitoring. Boasting 16.7 million colours 4K UHD Resolution these monitors will make your CCTV video come to life. Designed specifically to run for 24 hours a day, 7 days a week, 365 days a year and compatible with HDMI, VGA, DVI, BNC and Audio. 27, 43, 49, 55 and 65’’ 4K UHD LED screen size options.', '27, 43, 49, 55 and 65’’ 4K UHD LED screen size options', '3840 x 2160 screen resolution ', 'Designed for 24/7 monitoring ', 'HDMI, USB, VGA, DVI, BNC & Audio inputs', 'Desktop and VESA mounting options', 'Experience breathtaking level of details when you open your eyes to the clarity of 4K UHD screen', '5 ms GTG response time ', '16:9 widescreen resolution ', 'LED backlight technology provides for industry-leading low power consumption and less hazardous materials', 'Enjoy crisp content and energetic hues with the 300 cd/m² brightness', 'Analogue CVBS BNC input', 1),
('FHD monitors', 'FHD', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/fhd.png', '', 'Experience Full HD CCTV security monitoring. Designed specifically to run for 24 hours a day, 7 days a week, 365 days a year and compatible with BNC, HDMI, VGA, DVI and Audio.  These monitors combine extremely high contrast and low power consumption to be the perfect deploy-anywhere option. 20, 22, 24, 27, 32 and 43’’ Full HD LED screen size options.', '20, 22, 24, 32 and 43’’ Full HD LED screen size options', '1920 x 1080P screen resolution ', 'Designed for 24/7 monitoring ', 'BNC, HDMI, VGA & Audio inputs', 'Desktop and VESA mounting options', '6 ms GTG response time ', '16:9 widescreen resolution ', 'LED backlight technology provides for industry-leading low power consumption and less hazardous materials', '250 cd/m² brightness gives an exceptional visible display for clear and consistent on-screen pictures', '100mm x 100mm VESA Mounting Pattern', 'Analogue CVBS BNC input', 2),
('HD Monitors', 'HD', 'https://osprey-security.s3.eu-west-2.amazonaws.com/products/cameras/prod-images/hd.png', '', 'Experience HD CCTV security monitoring. Designed specifically to run for 24 hours a day, 7 days a week, 365 days a year and compatible with HDMI, VGA, DVI and   19, 24, 27 and 32\" HD LED screen size options.', '19, 24, 27 and 32\" HD LED screen size options', '1366 x 768 screen resolution ', 'Designed for 24/7 monitoring ', 'HDMI, VGA & Audio inputs', 'Desktop and VESA mounting options', '', '', '', '', '', '', 3);
...
--
-- Indexes for table `disk_nvr_info`
--
ALTER TABLE `disk_nvr_info`
  ADD PRIMARY KEY (`product_code`);

--
-- Indexes for table `eth_info`
--
ALTER TABLE `eth_info`
  ADD PRIMARY KEY (`product_code`);

--
-- Indexes for table `housings_info`
--
ALTER TABLE `housings_info`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `monitors_types`
--
ALTER TABLE `monitors_types`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `housings_info`
--
ALTER TABLE `housings_info`
...
--
-- AUTO_INCREMENT for table `monitors_types`
--
ALTER TABLE `monitors_types`
